...
# ──────────────────────────────
# v2校準：每因子擺動幅度 = 權重% × 550
#   還款紀錄35%→193(0~-193) 使用率30%→165(620~785)
#   信用年齡15%→83(-63~+20) 信用種類10%→55(-25~+30) 新申請10%→54(-39~+15)
# sum(min)=300, sum(max)=850 → 加總天然落在300~850
# ──────────────────────────────
...
# 最差：delinq≥4(-111)+pub_rec(-25)+collections(-19)+Late31-120(-38)=-193
# ──────────────────────────────
...
# ──────────────────────────────
# 因素4：信用種類 10% → 55分 (-25~+30)（dti + purpose）
# 回傳 (分數, 是否強制歸高風險)
# ──────────────────────────────
